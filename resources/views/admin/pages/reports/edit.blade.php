    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content" style="background-color: #435c70; color: white">
        ...
        <div class="modal-body">
          <form action="{{route('update.report.kedatangan', $report->id)}}" method="post">
            @csrf
            @method('put')
            ...
            <input type="date" name="tgl_sampai" id="tgl_sampai" class="form-control mb-2" value="{{old('tgl_sampai'), $report->tgl_sampai}}">
        </div>
        <div class="modal-footer">
            <a href="{{route('reports.index')}}" class="btn btn-secondary">Close</a>
