...
<html lang="en">
  <head>
    ...
    <title>PT. PAPUA EXPRESSINDO LOGISTIK | Admin Jayapura</title>
    <link
      rel="stylesheet"
          ...
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12 text-center">
                <h2 class="tm-block-title mb-4">Login Admin Jayapura</h2>
              </div>
            </div>
            <div class="row mt-2">
              <div class="col-12">
                <form action="{{route('jayapura.store.login')}}" method="post" class="tm-login-form">
                    @csrf
