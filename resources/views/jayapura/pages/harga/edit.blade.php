...
<div class="col-12 tm-block-col">
    <div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
        ...
        <form action="{{route('jayapura.harga.update', $harga->id)}}" method="POST">
        @csrf
        @method('PUT')
          ...
          <div class="form-group">
              ...
              <input type="text" name="kota_tujuan" id="kota_tujuan" class="form-control mb-2" value="{{old('kota_asal',$harga->kota_tujuan)}}">
          </div>
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" name="harga_min" id="harga_min" class="form-control" value="{{old('kota_asal', $harga->harga_min)}}">
            </div>
        </div>
