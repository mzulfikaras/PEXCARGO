    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content" style="background-color: #435c70; color: white">
        ...
        <div class="modal-body">
            <form action="{{route('jayapura.harga.store')}}" method="POST">
                @csrf
...
<div class="modal fade" id="importHarga" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="background-color: #435c70; color: white">
            ...
            <form action="{{ route('jayapura.harga.import') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
            ...
            <tbody>
                @foreach ($dataHarga as $harga)
                    <tr>
                        ...
                        <td>
                            <form action="{{route('jayapura.harga.hapus', $harga->id)}}" method="POST">
                                @csrf
                                @method('DELETE')

                                <a href="{{route('jayapura.harga.edit', $harga->id)}}" class="btn btn-warning"><i class="far fa-edit"></i></a>
