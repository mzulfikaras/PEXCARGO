...
<div class="tm-bg-primary-dark tm-block tm-block-taller tm-block-scroll">
        ...
        <a href="{{route('jayapura.invoice.create')}}" class="btn btn-primary">+ Data Pengiriman</a>
        <a target="_blank" class="btn btn-success ml-2" style="color: white" id="exportpdf">Print Data PDF</a>


        <form action="{{ route('jayapura.invoice.index') }}" method="get">
        ...
        <table class="table" style="text-align: center;" id="dataTables-example">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$data->total}}</td>
                    <td>
                        <form action="{{route('jayapura.invoice.destroy', $data->id)}}" method="POST">
                            @csrf
                            @method('DELETE')
...
<script>
    $(document).ready(function() {
        ...
        $('#exportpdf').attr('href', '/admin/jayapura/pengiriman/pdf/' + start.format('DD-MMM-YYYY') + '+' + end.format('DD-MMM-YYYY'))
        ...
        $('#created_at').daterangepicker({
            ...
            $('#exportpdf').attr('href', '/admin/jayapura/pengiriman/pdf/' + first.format('DD-MMM-YYYY') + '+' + last.format('DD-MMM-YYYY'))
        });
    })
</script>
@endsection
